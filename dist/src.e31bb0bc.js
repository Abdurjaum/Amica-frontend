...
exports.default = _default;
},{"gsap":"../node_modules/gsap/index.js"}],"InterestAPI.js":[function(require,module,exports) {
"use strict";
...
class InterestAPI {
  async getInterests() {
    // fetch the json data
    const response = await fetch("".concat(_App.default.apiBase, "/interest"), {
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken)
      }
    }); // if response not ok
...
var _InterestAPI = _interopRequireDefault(require("../../InterestAPI"));
...
class HomeView {
  ...
  async getInterests() {
    try {
      this.interests = await _InterestAPI.default.getInterests();
...
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","../../InterestAPI":"InterestAPI.js"}],"views/pages/404.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","../../UserAPI":"UserAPI.js","../../Toast":"Toast.js"}],"views/pages/discover.js":[function(require,module,exports) {
"use strict";
...
class MessageView {
  ...
  async getUserMessages() {
    var username = _Auth.default.currentUser.username;
  ...
  async getMessages() {
    try {
      this.allMessages = await _MessageAPI.default.getMessages();
    } catch (err) {
      _Toast.default.show(err, 'error');
    }
...
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","../../MessageAPI":"MessageAPI.js","../../Toast":"Toast.js"}],"views/pages/notifications.js":[function(require,module,exports) {
"use strict";
...
class NotificationView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      <va-app-header title=\"Notifications\" user=\"", "\"></va-app-header>\n      <div class=\"page-content\">        \n      <section class=\"section-50\">\n      <div class=\"container\">\n          <h3 class=\"m-b-50 heading-line\">Notifications &nbsp &nbsp<i class=\"fa fa-bell text-muted\"></i></h3>\n  \n          <div class=\"notification-ui_dd-content\">\n              <div class=\"notification-list notification-list--unread\">\n                  <div class=\"notification-list_content\">\n                      <div class=\"notification-list_img\">\n                          <img src=\"https://i.imgur.com/zYxDCQT.jpg\" alt=\"user\">\n                      </div>\n                      <div class=\"notification-list_detail\">\n                          <p><b>Fabrice</b> replied to your message</p>\n                          <p class=\"text-muted\">Hello ", ", how are you doing?</p>\n                          <p class=\"text-muted\"><small>10 mins ago</small></p>\n                      </div>\n                  </div>\n              </div>\n              <div class=\"notification-list notification-list--unread\">\n                  <div class=\"notification-list_content\">\n                      <div class=\"notification-list_img\">\n                          <img src=\"https://i.imgur.com/w4Mp4ny.jpg\" alt=\"user\">\n                      </div>\n                      <div class=\"notification-list_detail\">\n                          <p><b>Richard </b> messaged you</p>\n                          <p class=\"text-muted\">Hey ", " I already sent you the answers</p>\n                          <p class=\"text-muted\"><small>40 mins ago</small></p>\n                      </div>\n                  </div>\n              </div>\n              <div class=\"notification-list\">\n                  <div class=\"notification-list_content\">\n                      <div class=\"notification-list_img\">\n                          <img src=\"https://i.imgur.com/CtAQDCP.jpg\" alt=\"user\">\n                      </div>\n                      <div class=\"notification-list_detail\">\n                          <p><b>Lance </b> replied to your message</p>\n                          <p class=\"text-muted\">I will find some day to catchup with you ", "</p>\n                          <p class=\"text-muted\"><small>1 hour ago</small></p>\n                      </div>\n                  </div>\n              </div>\n              <div class=\"notification-list\">\n                  <div class=\"notification-list_content\">\n                      <div class=\"notification-list_img\">\n                          <img src=\"https://i.imgur.com/zYxDCQT.jpg\" alt=\"user\">\n                      </div>\n                      <div class=\"notification-list_detail\">\n                          <p><b>Michael </b>sent you a message</p>\n                          <p class=\"text-muted\">Hello ", ", how are you doing?</p>\n                          <p class=\"text-muted\"><small>2 days ago</small></p>\n                      </div>\n                  </div>\n              </div>\n          </div>\n  \n      </div>\n  </section>\n      </div>      \n    "])), JSON.stringify(_Auth.default.currentUser), _Auth.default.currentUser.username, _Auth.default.currentUser.username, _Auth.default.currentUser.username, _Auth.default.currentUser.username);
    (0, _litHtml.render)(template, _App.default.rootEl);
  }

}

var _default = new NotificationView();

exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js"}],"FriendrequestAPI.js":[function(require,module,exports) {
"use strict";
...
class FriendrequestAPI {
  async getFriendrequest() {
    // fetch the json data
    const response = await fetch("".concat(_App.default.apiBase, "/friendrequest"), {
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken)
      }
    }); // if response not ok
...
var _default = new FriendrequestAPI();

exports.default = _default;
},{"./App":"App.js","./Auth":"Auth.js","./Toast":"Toast.js"}],"views/pages/friendrequest.js":[function(require,module,exports) {
"use strict";
...
var _FriendrequestAPI = _interopRequireDefault(require("../../FriendrequestAPI"));
...
class FriendrequestView {
  ...
  async getFriendrequest() {
    try {
      this.friendrequests = await _FriendrequestAPI.default.getFriendrequest();
...
class InterestsView {
  async init() {
    ...
    await this.getInterests(); //this.filterInterests('member', '10-30')
  }
  ...
  handleFilterBtn(e) {
    ...
    console.log("match = ", match); // filter interests
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n\n      <style>\n        .filter-menu {\n          display: flex;\n          align-items; center;\n        }\n\n        .filter-menu > div {\n          margin-right: 1em;\n        }\n      </style>\n\n      <va-app-header title=\"Interests\" user=\"", "\"></va-app-header>\n      <div class=\"page-content\">   \n      \n        <div class=\"filter-menu\">\n          <div>\n            <h3>Filter by</h3>\n          </div>\n          <div>\n            <strong>Interests</strong>\n            <sl-button class=\"filter-btn\" size=\"small\" data-field=\"name\" data-match=\"Football\" @click=", ">Football</sl-button>\n            <sl-button class=\"filter-btn\" size=\"small\" data-field=\"name\" data-match=\"Basketball\" @click=", ">Basketball</sl-button>\n            <sl-button class=\"filter-btn\" size=\"small\" data-field=\"name\" data-match=\"Swimming\" @click=", ">Swimming</sl-button>\n            <sl-button class=\"filter-btn\" size=\"small\" data-field=\"name\" data-match=\"Hiking\" @click=", ">Hiking</sl-button>\n            <sl-button class=\"filter-btn\" size=\"small\" data-field=\"name\" data-match=\"Weight-Lifting\" @click=", ">Weight-Lifting</sl-button>\n          </div>\n\n          <div>\n            <strong>Members</strong>\n            <sl-button class=\"filter-btn\" size=\"small\" data-field=\"member\" data-match=\"10-20 members\" @click=", ">10-20 members</sl-button>\n            <sl-button class=\"filter-btn\" size=\"small\" data-field=\"member\" data-match=\"20-30 members\" @click=", ">20-30 members</sl-button>\n            <sl-button class=\"filter-btn\" size=\"small\" data-field=\"member\" data-match=\"30-40 members\" @click=", ">30-40 members</sl-button>\n          </div>\n\n          <div>\n            <sl-button size=\"small\" @click=", ">Clear Filters</sl-button>\n          </div>\n        </div>\n      \n\n       <div class=\"interests-grid\">\n       ", "\n       </div>\n        \n      </div>      \n    "])), JSON.stringify(_Auth.default.currentUser), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.clearFilters.bind(this), this.interests == null ? (0, _litHtml.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n         <sl-card><sl-card>\n       "]))) : (0, _litHtml.html)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n         ", "\n      "])), this.interests.map(interest => (0, _litHtml.html)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n           <sl-card class=\"interest-card\">\n            <img src=\"", "/images/", "\" alt=\"", "\" slot=\"image\" />\n            <h2>", "</h2>\n            <h4>", "</h4>\n            <p></p>\n            <h4>", "</h4>\n            <p></p>\n            <p>Group monitored by ", " ", "</p>\n\n           </sl-card>\n         "])), _App.default.apiBase, interest.image, interest.name, interest.name, interest.member, interest.description, interest.user.firstName, interest.user.lastName))));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }

}

var _default = new InterestsView();

exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","../../InterestAPI":"InterestAPI.js","../../Toast":"Toast.js"}],"GroupAPI.js":[function(require,module,exports) {
"use strict";
...
class GroupAPI {
  async getGroup() {
    // fetch the json data
    const response = await fetch("".concat(_App.default.apiBase, "/group"), {
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken)
      }
    }); // if response not ok
    ...
    if (!response.ok) {
      ...
      throw new Error('Problem getting groups');
    } // convert response payload into json - store as data
...
var _default = new GroupAPI();

exports.default = _default;
},{"./App":"App.js","./Auth":"Auth.js","./Toast":"Toast.js"}],"views/pages/group.js":[function(require,module,exports) {
"use strict";
...
var _GroupAPI = _interopRequireDefault(require("../../GroupAPI"));
...
class GroupView {
  ...
  async getGroup() {
    try {
      this.group = await _GroupAPI.default.getGroup();
...
var _default = new GroupView();

exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","../../GroupAPI":"GroupAPI.js","../../Toast":"Toast.js"}],"Router.js":[function(require,module,exports) {
"use strict";
...
var _discover = _interopRequireDefault(require("./views/pages/discover"));

var _messages = _interopRequireDefault(require("./views/pages/messages"));

var _notifications = _interopRequireDefault(require("./views/pages/notifications"));

var _friendrequest = _interopRequireDefault(require("./views/pages/friendrequest"));

var _interests = _interopRequireDefault(require("./views/pages/interests"));

var _group = _interopRequireDefault(require("./views/pages/group"));
...
const routes = {
  ...
  '/friendrequest': _friendrequest.default,
  '/interests': _interests.default,
...
},{"./views/pages/home":"views/pages/home.js","./views/pages/404":"views/pages/404.js","./views/pages/signin":"views/pages/signin.js","./views/pages/signup":"views/pages/signup.js","./views/pages/profile":"views/pages/profile.js","./views/pages/editProfile":"views/pages/editProfile.js","./views/pages/guide":"views/pages/guide.js","./views/pages/discover":"views/pages/discover.js","./views/pages/messages":"views/pages/messages.js","./views/pages/notifications":"views/pages/notifications.js","./views/pages/friendrequest":"views/pages/friendrequest.js","./views/pages/interests":"views/pages/interests.js","./views/pages/group":"views/pages/group.js"}],"App.js":[function(require,module,exports) {
"use strict";
