  ...
  render(){    
    ...
    <header class="app-header">
      ...
      <nav class="app-top-nav">
        ...
        <a href="/discover" @click="${anchorRoute}">Discover</a>
        <a href="/messages" @click="${anchorRoute}">Messages</a>    
        <a href="/notifications" @click="${anchorRoute}">Notifications</a>    
        <sl-dropdown>
    ...
    <sl-drawer class="app-side-menu" placement="left">
      ...
      <nav class="app-side-menu-items">
        ...
        <a href="/discover" @click="${this.menuClick}">Discover</a>
        <a href="/messages" @click="${this.menuClick}">Messages</a>
        <a href="/notifications" @click="${this.menuClick}">Notifications</a>
        <a href="/interests" @click="${this.menuClick}">Interest Groups</a>
        <a href="/friendrequest" @click="${this.menuClick}">Friend Requests</a>
